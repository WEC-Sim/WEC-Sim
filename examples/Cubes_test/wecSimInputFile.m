...
simu.simMechanicsFile = 'single_body.slx';      % Specify Simulink Model File
...
%% Body Data
% Float
body(1) = bodyClass('hydroData/coer_comp.h5');      
...
body(1).mass = 'equilibrium';                   
    ...
    % Weight.
body(1).momOfInertia = [1e5 1e5 1e5];  %Moment of Inertia [kg*m^2]     
