...
%% Body Data
% Float
body(1) = bodyClass({'hydroData/rm3.h5','hydroData/rm3.h5','hydroData/rm3.h5'});
...
% Spar/Plate
body(2) = bodyClass({'hydroData/rm3.h5','hydroData/rm3.h5','hydroData/rm3.h5'}); 
...
%%
% body(1).hydroForce.a = 1;
% body(1).hydroForce.b = 1;
% body(1).hydroForce.c = 1;
% body(1).hydroForce(2) = body(1).hydroForce(1);
% body(2).hydroForce = body(1).hydroForce;
