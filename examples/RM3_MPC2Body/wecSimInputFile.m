...
simu.simMechanicsFile = 'RM3ControlSim2.slx';      %Location of Simulink Model File
...
simu.stateSpace = 1;						%Control option to use state space model 
...
pto(1).damping=0*1200000;                               %PTO Daming [N/(m/s)]
