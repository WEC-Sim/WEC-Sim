...
mesh_file = os.path.join(input_data_dir, "ellipsoid.dat")
...
test_matrix = xr.Dataset(coords={
    "omega": np.linspace(0.03, 9.24, 308),
...
cpt.export_dataset(os.path.join(output_dir, 'ellipsoid_hydrodynamics.nc'), dataset)
