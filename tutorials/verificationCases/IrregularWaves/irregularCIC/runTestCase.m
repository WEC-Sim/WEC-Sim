...
fprintf(['\nBody1_Heave Max Diff = ' num2str(irregularCIC.B1_H_max) ...
    ' m at time = ' num2str(B1.WEC_Sim_org.time(irregularCIC.B1_H_I)) 's\n'])
fprintf(['Body2_Heave Max Diff = ' num2str(irregularCIC.B2_H_max) ...
    ' m at time = ' num2str(B2.WEC_Sim_org.time(irregularCIC.B2_H_I)) 's\n'])
fprintf(['Relative_Heave Max Diff = ' num2str(irregularCIC.Rel_H_max) ...
    ' m at time = ' num2str(Rel.WEC_Sim_org.time(irregularCIC.Rel_H_I)) 's\n'])
...
str1=['Max Diff = ' num2str(irregularCIC.B1_H_max) ' m'];
str2=['at time = ' num2str(B1.WEC_Sim_org.time(irregularCIC.B1_H_I)) 's'];
...
str1=['Max Diff = ' num2str(irregularCIC.B2_H_max) ' m'];
str2=['at time = ' num2str(B1.WEC_Sim_org.time(irregularCIC.B2_H_I)) 's'];
...
str1=['Max Diff = ' num2str(irregularCIC.Rel_H_max) ' m'];
str2=['at time = ' num2str(Rel.WEC_Sim_org.time(irregularCIC.Rel_H_I)) 's'];
a=text(10,1.5,str1);set(a,'FontSize',12)
a=text(10,1.2,str2);set(a,'FontSize',12)
xlim([0 200])
ylim([-2 2])
