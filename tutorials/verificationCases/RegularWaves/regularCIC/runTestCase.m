...
fprintf(['\nBody1_Heave Max Diff = ' num2str(regularCIC.B1_H_max) ...
    ' m at time = ' num2str(B1.WEC_Sim_org.time(regularCIC.B1_H_I)) 's\n'])
fprintf(['Body2_Heave Max Diff = ' num2str(regularCIC.B2_H_max) ...
    ' m at time = ' num2str(B2.WEC_Sim_org.time(regularCIC.B2_H_I)) 's\n'])
fprintf(['Relative_Heave Max Diff = ' num2str(regularCIC.Rel_H_max) ...
    ' m at time = ' num2str(Rel.WEC_Sim_org.time(regularCIC.Rel_H_I)) 's\n'])
