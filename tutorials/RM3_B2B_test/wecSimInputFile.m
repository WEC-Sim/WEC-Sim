...
simu.simMechanicsFile = 'RM3_B2B_test.slx';      %Location of Simulink Model File
...
%% Heave Initial Displacement
body(1).initDisp.initLinDisp(3) = 1;
% body(2).initDisp.initLinDisp(3) = 0.03;
% body(3).initDisp.initLinDisp(3) = 0.03;
