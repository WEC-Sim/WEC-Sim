function f = regWaveMorison(z,r,Vel,Accel,Disp,Area,Cd,Vol,Ca,Time,rho,direction,waterDepth,k,w,A,rampTime,g,currentSpeed,currentDirection,currentDepth,currentOption,simuMorison)
