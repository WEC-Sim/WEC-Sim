function f  = waveElevation(x,center,cg,AH,w,dw,k,typeNum,t,rampT,phaseRand,waveDirection)
...
f = calc_elev(x,center,cg,AH,w,dw,k,typeNum,t,rampT,phaseRand, waveDirection);
end

function f = calc_elev(x,center,cg,AH,w,dw,k,typeNum,t,rampT,phaseRand,waveDirection)
...
f=waveElev(center,AH,w,dw,t,k,rampT,phaseRand,typeNum,waveDirection);
end

function f=waveElev(center,AH,w,dw,t,k,rampT,phaseRand,typeNum,waveDirection)
% Function to calculate the wave elevation at an array of points
f = zeros(length(center(:,3)),1);
cx = center(:,1);
cy = center(:,2);
X = cx*cos(waveDirection*pi/180) + cy*sin(waveDirection*pi/180);
if typeNum <10
elseif typeNum <20
