function [Fext,relYawLast,coeffsLastMD,coeffsLastRE,coeffsLastIM] = regnLYaw(A,w,dofGRD,dirGRD,fEHRE,fEHIM, fEHMD,time,waveDirection,Disp, intThresh, prevYaw, prevCoeffMD, prevCoeffRE, prevCoeffIM)
%#codegen
...
for ii=1:length(waveDirection) % should be length=1 for regular waves
    relYaw=waveDirection(ii)-(Disp(6).*180/pi); % relative yaw angle, convert to deg
