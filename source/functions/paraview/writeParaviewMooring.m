function writeParaviewMooring(moorDyn, model,t,simdate,nline,nnode,paraviewDirectory,TimeBodyParav,NewTimeParaview)
...
for it = 1:length(TimeBodyParav)
    % open file
    filename = [paraviewDirectory, filesep 'mooring' filesep 'mooring_' num2str(it) '.vtp'];
