function writeParaviewResponse(bodies, t, model, simdate, wavetype, mooring, paraviewDirectory)
...
% open file
% fid = fopen([paraviewDirectory, fs model(1:end-4) '.pvd'], 'w');
fid = fopen([paraviewDirectory, fs model '.pvd'], 'w');
% write header
