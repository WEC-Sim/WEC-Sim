...
classdef waveClass<handle
    ...
    properties (SetAccess = 'public', GetAccess = 'public')%input file     
        ...
        marker = struct(...         % (`structure`) Defines the wave marker. 
            'location',      [],...          % 
            'size',     10, ...         %             
            'style',	1)              % (`structure`) Defines the wave marker. `location` (`nx2 vector`) Marker [X,Y] locations [m]. Default = ``[]``. ``size`` (`float`) Marker size in Pixels. Default = ``10``. ``style`` Marker style, options include: ``1``: Sphere, ``2``: Cube, ``3``: Frame. Default = ``1``: Sphere        
