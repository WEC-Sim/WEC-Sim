...
classdef simulationClass<handle
    ...
    properties (SetAccess = 'public', GetAccess = 'public')%input file
        ...
        zeroCrossCont       = 'DisableAll'                                 % (`string`) Disable zero cross control (default = disabled)
        ...
        yawNonLin           = 0                                            % (`integer`) Option for nonlinear yaw calculation linear->0, nonlinear->1 for nonlinear) 
        yawThresh           = 1                                            % (`float`) Yaw position threshold (in degrees) above which excitation coefficients will be interpolated in non-linear yaw
        ...
        mcrCaseFile         = []                                           % (`string`) mat file that contain a list of the multiple conditions runs with given conditions  
