...
classdef bodyClass<handle
    ...
    properties (SetAccess = 'public', GetAccess = 'public') % WEC-Sim input
        ...
        nonHydro (1,1) {mustBeInteger}              = 0                     % (`integer`) Flag for non-hydro body pre-processing. Options: 0 (hydro body), 1 (non-hydro body), 2 (drag body). Body type determined by the library block. Default = ``0``.
