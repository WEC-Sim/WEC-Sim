...
project = "WEC-Sim"
copyright = (
    "2022, National Laboratory of the Rockies and National "
...
exclude_patterns = ["_include", "_assets"]
...
latex_documents = [
    (
        ...
        "Yi-Hsiang Yu, Kelley Ruehl, Jennifer Van Rij, Nathan Tom, Dominic Forbush",
        "manual",
    ),
]
...
man_pages = [(root_doc, "WEC-Sim", "WEC-Sim Documentation", [author], 1)]
